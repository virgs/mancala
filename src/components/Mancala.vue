            ...
            <div class="row g-2 h-100">
                <div class="col">
                    <Hole
                        :stones="board[6]"
                        :index="6"
                        :playingPlayerIdentifier="playingPlayer?.identifier"
                        :store="true"
                        :ownerBrain="topPlayer.brainLevel"
                        @nextActionSelected="nextActionSelected"
                        :owner="PlayerIdentifier.TOP"
                    >
                    </Hole>
                </div>
                <div class="col-8">
                    ...
                    <div class="row g-0 justify-content-center" style="height: 50%">
                        <div v-for="(pocket, index) in bottomInternalPockets" class="col mx-auto">
                            <Hole
                                ...
                                :ownerBrain="bottomPlayer.brainLevel"
                                :playingPlayerIdentifier="playingPlayer?.identifier"
                                :store="false"
                                @nextActionSelected="nextActionSelected"
                                :owner="PlayerIdentifier.BOTTOM"
                            ></Hole>
                        </div>
                    </div>
                </div>
